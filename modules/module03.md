...
+ For Azure Resource Manager Connection, select Select the Azure Resource Manager service connection having access to the selected deployment scope. This is the service connection created as part of [Azure DevOps Prerequisite](../Files/AzureDevOps/DevOps-Prerequisites.md)
