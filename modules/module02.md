...
Name it as package.json and copy [package.json](../Files/AzureDevOps/package.json) (Right click to open in new window) code and replace contents in the file with copied code. Click on Commit and then commit again.
