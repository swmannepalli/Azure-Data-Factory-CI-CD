...
2. **Resources Deployment:**  Make a note of SQL User Password as it is needed in later steps. Check if the directory is pointing to current subscription when clicked on Deploy buttons, if not, switch directory.
