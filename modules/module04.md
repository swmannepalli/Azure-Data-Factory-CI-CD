...
+ Click on Add an artifact, This should be the artifact generated by our build pipeline (adf-CI). For Source type, select Azure Repos Git and select Project, repository. Select Default branch as adf_publish which is the branch to checkout. You can have separate branch created for this as well. Click on Add.
